          ...
          {beingEdited ? (
            ...
            <div className="action-container">
              <div className="action-icon" onClick={() => setBeingEdited(true)}>
                <img
                  src="https://cdn-icons-png.flaticon.com/128/10074/10074250.png"
                  alt="edit"
                />
              </div>
              <div className="action-icon" onClick={handelDelete}>
                <img
                  src="https://cdn-icons-png.flaticon.com/128/3259/3259625.png"
                  alt="delete"
                />
              </div>
              <div className="action-icon" onClick={addProductToCart}>
                <img
                  src="https://cdn-icons-png.flaticon.com/128/4893/4893746.png"
                  alt="addToCart"
                />
              </div>
            </div>
